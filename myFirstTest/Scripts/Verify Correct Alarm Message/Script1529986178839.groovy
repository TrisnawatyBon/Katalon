...
Mobile.tap(findTestObject('Application/App/Activity/android.widget.TextView - Activity'), 10)

Mobile.comment('When he taps on the Custom Dialog button')

Mobile.tap(findTestObject('Application/App/Activity/Custom Dialog/android.widget.TextView - Custom Dialog'), 10)
